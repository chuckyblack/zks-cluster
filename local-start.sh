...
docker run --name="kafka3" -d -e "KAFKA_ADVERTISED_PORT=9092" -e "KAFKA_ADVERTISED_HOST_NAME=172.17.0.5" -e "KAFKA_BROKER_ID=31" -e "KAFKA_ZOOKEEPER_CONNECT=$ZK_POOL" performio/kafka
